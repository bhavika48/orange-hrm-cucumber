...
//***************************** Is Display Methods **********************************************//
    ...
    public void searchByVisibleTextFromDropDown(By by, String text) {
        WebElement dropDown = driver.findElement(by);
        WebElement element = dropDown.findElement(By.xpath("//div[contains(text(),'" + text + "')]"));
        element.clear();
    }

    public void searchByVisibleTextFromDropDown(WebElement webElement, String text) {
